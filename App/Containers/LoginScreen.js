      ...
      <View style={styles.container}>
        ...
        <KeyboardAvoidingView behavior="padding" style={styles.containerLogin}>
          <View style={styles.containerInput}>
            ...
            <TextInput underlineColorAndroid='transparent' placeholder="Digite sua matrícula" style={styles.textInput} />
          </View>

          <View style={styles.containerInput}>
            <Icon name="lock" size={20} color="#fff" style={styles.inlineIcon} />
            <TextInput underlineColorAndroid='transparent' secureTextEntry placeholder="Digite sua senha" style={styles.textInput} />
          </View>
